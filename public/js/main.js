...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1633f2ec", module.exports)
  } else {
    hotAPI.update("_v-1633f2ec", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
    props: ["isToday", "isDisplayedMonth", "isCurrentMonth", "day"],

    computed: {},
    methods: {}
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<v-card v-bind:class=\"{ 'indigo lighten-4': isDisplayedMonth, 'blue lighten-4': isCurrentMonth,'box-today':isToday}\" height=\"80px\" style=\"padding: 2px\">\n                <v-card-text class=\"pa-0\">\n                                    <p v-if=\"isToday==true\" class=\"text-xs-right\"><b>{{Number(day.format('DD')).toString()}}</b></p>\n                                    <p v-else=\"\" class=\"text-xs-right\">{{Number(day.format('DD')).toString()}}</p>\n                </v-card-text>\n</v-card>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2bbe0536", module.exports)
  } else {
    hotAPI.update("_v-2bbe0536", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _monthCalendar = require('./monthCalendar.vue');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-43f00efb", module.exports)
  } else {
    hotAPI.update("_v-43f00efb", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./monthCalendar.vue":10,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5}],10:[function(require,module,exports){
var __vueify_insert__ = require("vueify/lib/insert-css")
var __vueify_style__ = __vueify_insert__.insert("\n\n")
'use strict';
...
var _controlMonth = require('./controlMonth.vue');

var _controlMonth2 = _interopRequireDefault(_controlMonth);

var _dayBox = require('./dayBox.vue');
...
exports.default = {
  ...
  computed: {
    momentNow: function momentNow() {
      return new _moment2.default();
    },
    momentNowOffset: function momentNowOffset() {
      return new _moment2.default().add(this.offsetMonth, 'month').add(this.offsetDay, 'days').add(this.offsetWeek, 'weeks');
    },
    momentFirstDayOfCurrentMonth: function momentFirstDayOfCurrentMonth() {
      var localmomentNowOffset = new _moment2.default().add(this.offsetMonth, 'month').add(this.offsetDay, 'days').add(this.offsetWeek, 'weeks');
  ...
  methods: {
    ...
    isToday: function isToday(i, n) {
      ...
      if ((0, _moment2.default)().isSame(auxDateStart, 'day')) {
        return true;
      } else {
        return false;
      }
    ...
    isCurrentMonth: function isCurrentMonth(i, n) {
      var auxDateStart = this.getActualDay(i, n);
      if ((0, _moment2.default)().isSame(auxDateStart, 'month')) {
        return true;
      } else {
        return false;
      }
    ...
    isDisplayedMonth: function isDisplayedMonth(i, n) {
      if ((0, _moment2.default)(this.getActualDay(i, n)).isSame(this.momentNowOffset, 'month')) {
        return true;
      } else {
        return false;
      }
  ...
  components: { dayBox: _dayBox2.default, controlMonth: _controlMonth2.default }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"pa-0\">\n            <controlmonth :displayed-month-date=\"momentNowOffset\" v-on:upmonth=\"addMonth\" v-on:downmonth=\"downMonth\">\n            </controlmonth>\n            <v-container fluid=\"\" class=\"pa-0\">\n                <v-layout>\n                    <v-flex xs12=\"\" sm12=\"\">\n                        <v-container fluid=\"\" class=\"pa-0\">\n                            <v-layout>\n                                <v-flex xs10=\"\">\n                                    <v-container class=\"pb-0\" fluid=\"\" grid-list-md=\"\">\n                                        <v-layout row=\"\" wrap=\"\" v-for=\"n in 6\" :key=\"n\">\n                                            <v-flex v-if=\"n==1\" style=\"width: 14.28%\" v-for=\"i in 7\" :key=\"i\">\n                                                <v-card style=\"padding: 2px\">\n                                                    <v-card-text style=\"padding: 0px\" primary-title=\"\">\n                                                        <div>\n                                                            <h1 class=\"text-xs-center headline mb-0\">{{momentNow.day(i).format('dddd')}}</h1>\n                                                        </div>\n                                                    </v-card-text>\n                                                </v-card>\n                                            </v-flex>\n                                            <v-flex v-if=\"n>=1\" style=\"width: 14.28%\" v-for=\"i in 7\" :key=\"i\">\n                                                <daybox :is-today=\"isToday(i,n)\" :is-current-month=\"isCurrentMonth(i,n)\" :is-displayed-month=\"isDisplayedMonth(i,n)\" :day=\"getActualDay(i,n)\">\n                                                </daybox>\n                                            </v-flex>\n                                        </v-layout>\n                                    </v-container>    \n                                </v-flex>\n                            </v-layout>\n                        </v-container>\n                    </v-flex>\n                </v-layout>\n            </v-container>\n        </div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-38836107", module.exports)
  } else {
    hotAPI.update("_v-38836107", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./controlMonth.vue":7,"./dayBox.vue":8,"moment":1,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5}],11:[function(require,module,exports){
'use strict';
...
var _index = require('./components/calendar/index.vue');
...
},{"./components/calendar/index.vue":9,"vue":4,"vuetify":6}]},{},[11]);
